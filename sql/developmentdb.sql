...
--
-- Host: mysql
-- Generation Time: Jun 16, 2024 at 01:57 PM
...
-- Database: `jumbo2`
--
CREATE DATABASE IF NOT EXISTS `jumbo2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `jumbo2`;
...
INSERT INTO `order` (`id`, `userid`, `order_date`, `total`, `status`) VALUES
                                                                          ...
                                                                          (20, 16, '2024-06-16 12:29:55', 4.00, 2);
...
INSERT INTO `product` (`id`, `name`, `price`, `stock`, `description`, `image`, `category_id`) VALUES
                                                                                                  ...
                                                                                                  (28, 'Cucumber', 234.00, 643, 'dascdcv', 'https://media.istockphoto.com/id/91516166/photo/cucumber-slices-on-a-white-background.jpg?s=612x612&w=0&k=20&c=n4R8_HB2qEmTgOU3xlINv1Am2Z_Mt4CuJiITPta58vw=', 5);
...
INSERT INTO `user` (`id`, `username`, `password`, `email`, `role`) VALUES
                                                                       ...
                                                                       (9, 'steve', '$2y$10$F1uD73oN0b7tCtOVQqKBPuqQHN/e7ClweQeSgJDObBTVfarlqQPCG', 'steve', 1),
                                                                       (11, 'start', '$2y$10$MBpDxhp.4mG.CbNjPcuuauBwoGNl5PZj.fXjdURDXiBlJBdqviYea', 'test@test.com', 2),
                                                                       (12, 'sleepwad', '$2y$10$.bVlePC7rEbU1qNWg.YMU.7IXsk/1dhiUvFdtcpegGFCD6GA3ePpS', 'sleepwad@swas', 2),
                                                                       (13, 'ghuji4', '$2y$10$/XayihiPvs.1cBEczcrNo.GG75yWmbBLQMoxc1gut2bO2IKvmuA7u', 'ghuji4@dw', 2),
                                                                       (14, 'hgd', '$2y$10$wbPIJ7QdODxm5DYUIwtGQOzZPm87VpMlM/pI.hHSgfmCx7hfYJJuq', 'hgd', 2),
                                                                       (15, 'wadawdsa', '$2y$10$mrWhP0wlel0Jmep.XtkOB.NpjrIPeA17HXH5DyhB315BvIobx0wfi', 'wadawdsa', 2),
                                                                       (16, 'hhh', '$2y$10$uGXKLuupFInEoyMFe726q.PXu6pXE6zjt4iHjHw6ztHI6ByxG5iTi', 'hhh', 2);
